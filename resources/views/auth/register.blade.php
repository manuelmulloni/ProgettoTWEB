    ...
    <div class="container">
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data"
            ...
            <div class="container">
                ...
                <input id="nome" type="text" name="nome" value="{{ old('nome') }}" required autocomplete="nome"
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                @error('nome')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="container">
                ...
                <input id="dataNascita" type="date" name="dataNascita" value="{{ old('dataNascita') }}" required
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                @error('dataNascita')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="container">
                ...
                <input id="indirizzo" type="text" name="indirizzo" value="{{ old('indirizzo') }}" required
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('login') }}" class="text-sm text-indigo-600 hover:text-indigo-900 underline">Already
                    registered?</a>
                <br>
